...
export default function ApiKeyInput({ isOpen, onClose, onSuccess }: ApiKeyInputProps) {
    ...
    <div className="fixed inset-0 bg-black/70 backdrop-blur-sm flex items-center justify-center z-50 p-4">
      ...
      >
        ...
        <p className="text-zinc-300 mb-6">
          The default API key is rate-limited. Please enter your own OpenRouter API key 
          to continue using Snip. Your key will be stored locally and never sent to our servers.
        </p>
